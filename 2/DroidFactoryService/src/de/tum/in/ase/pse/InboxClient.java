...
public final class InboxClient {
    ...
    public void droidReadyR2(String droid) {
        ResponseEntity<String> response=rest.postForEntity(BASE_URL+R_2,createHttpEntity(droid),String.class);
        messages.add(response.getBody());
    }
    public void droidReady3PO(String droid) {
        ResponseEntity<String> response=rest.postForEntity(BASE_URL+THREE_PO,createHttpEntity(droid),String.class);
        messages.add(response.getBody());    
    }
